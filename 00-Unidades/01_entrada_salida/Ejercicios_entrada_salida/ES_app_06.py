...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        alert("Calculadora", f"el resultado de la suma es {resultado}")

#se pasan los str a numeros enteros usando el int y se suman
#se usa la f (format) para poder añadir un texto al resultado final y poder agregar {resultado}
