...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        alert("Alerta", "Fin del programa")
        
#se usa el if para cuando se quiere mostrar un mensaje pero tiene que cumplir algun requisito
# == se usa para comparar o igualar
